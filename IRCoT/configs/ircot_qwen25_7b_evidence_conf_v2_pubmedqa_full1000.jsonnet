# PubMedQA config using the full PQA-L 1,000-question corpus (~3,358 passages).
# Same as v2_pubmedqa_pmid but retrieves from pubmedqa_pmid_full_1000 so gold
# passages compete against ~3,300 distractor passages from other PMIDs.
local model_name = std.extVar("MODEL");
local retrieval_corpus_name = "pubmedqa_pmid_full_1000";
