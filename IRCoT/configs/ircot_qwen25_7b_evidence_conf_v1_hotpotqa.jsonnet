# Clean corrected HotpotQA config for official IRCoT with Qwen HF.
# Use with CLI --config-id ircot_qwen25_7b_evidence_conf_v1.
...

{
    ...
    "models": {
        ...
        "step_by_step_cot_reasoning_gen": {
            ...
            "prompt_file": project_dir + "/prompts/hotpotqa/hotpotqa_context_cot_reasoning_qwen.txt",
            "question_prefix": "",
        ...
        "answer_main_question": {
            "name": "llmqa",
            "next_model": null,
            "prompt_file": project_dir + "/prompts/hotpotqa/hotpotqa_evidence_conf_qwen.txt",
            "question_prefix": "",
            "prompt_reader_args": prompt_reader_args,
            "end_state": "[EOQ]",
            "gen_model": "hf_local",
