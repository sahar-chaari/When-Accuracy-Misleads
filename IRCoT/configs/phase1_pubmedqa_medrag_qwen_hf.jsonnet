# Phase 1 PubMedQA config using official IRCoT control flow and a combined MedRAG medical index.
...

{
    ...
    "models": {
        ...
        "step_by_step_cot_reasoning_gen": {
            ...
            "prompt_file": "../../prompts/pubmedqa/medical_context_cot_qa_qwen.txt",
        ...
        "answer_main_question": {
            "name": "llmqa",
            "next_model": null,
            "prompt_file": "../../prompts/pubmedqa/medical_yes_no_maybe_direct_qa_qwen.txt",
            "question_prefix": "",
            "prompt_reader_args": prompt_reader_args,
            "end_state": "[EOQ]",
            "gen_model": "hf_local",
